...
function NewProductPage() {
    ...
    const [price, setPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // keep as string; API will coerce for Decimal
    ...
    async function uploadToCloudinary() {
        ...
        const res = await fetch("https://api.cloudinary.com/v1_1/".concat(("TURBOPACK compile-time value", "dovr0ar5i"), "/image/upload"), {
            method: "POST",
            body: fd
        });
        ...
        if (!res.ok || !json.secure_url) {
            var _json_error;
            throw new Error(((_json_error = json.error) === null || _json_error === void 0 ? void 0 : _json_error.message) || "Image upload failed");
        }
...
_s(NewProductPage, "N9c5SQacjL3MUkIvQ9HLlVirvPk=", false, function() {
    return [
...
//# sourceMappingURL=_b979713e._.js.map